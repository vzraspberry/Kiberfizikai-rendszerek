...
<style type="text/css">
body {
	background-image: url(webpbck.jpg);
  ...
  <tbody>
    <tr>
      <td><table width="800">
        <tbody>
          <tr>
            <td width="300" valign="middle" height="100" align="center"><img src="logo2.jpg" width="300" height="100" alt=""/></td>
            <td width="500" align="center" valign="middle"><table width="400" border="0" cellpadding="1" cellspacing="1">
              <tbody>
                <tr>
                  <td width="194" align="right">Thermostat aktuális éréték:</td>
                  <td width="144" align="center" valign="middle"><?php echo $value." 'C"; ?></td>
                  <td width="52" align="left" valign="middle"><form id="form1" name="form1" method="post" action="thermo.php">
                <label><input type="submit" name="Submit" value="Módositás" />
                </label>
              </form></td>
                </tr>
              </tbody>
    ...
    <tr>
      <td><table width="800">
        <tbody>
          <tr>
            <td width="238"><table width="250" height="248">
              <tbody>
                <tr>
                  <td colspan="2"><strong>Komfort adatok:</strong></td>
                  </tr>
                <tr>
                  <td width="120" align="left">Hőmérséklet:</td>
                  <td width="100" align="left"><strong><?php echo $tmp." 'C"; ?></strong></td>
                </tr>
                <tr>
                  <td width="120" align="left">Páratartalom:</td>
                  <td align="left"><strong><?php echo $hum." %"; ?></strong></td>
                </tr>
                <tr>
                  <td width="120" align="left">Légnyomás:</td>
                  <td align="left"><strong><?php echo $press." mBar"; ?></strong></td>
                </tr>
                <tr>
                  <td width="120" rowspan="2" align="left">Legutolsó mérés időpontja:</td>
                  <td align="left"><strong><?php echo $date; ?></strong></td>
                </tr>
                <tr>
                  <td align="left"><strong><?php echo $time; ?></strong></td>
                </tr>
                <tr>
            ...
            <td width="550" valign="top"><table width="550">
              <tbody>
              </tbody>
              <tbody>
                <tr>
                ...
                <tr>
                  ...
                  <td width="120" rowspan="3">Tűzjelzés:</td>
                  <td width="120">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="120" rowspan="3">Áramszünet:</td>
                  <td width="120">&nbsp;</td>
                </tr>
                <tr>
                  <td align="left">&nbsp;</td>
                  <td width="120" valign="middle" align="left">&nbsp;</td>
